output "app_url" {
  value = var.cloud_provider == "azure" && var.db_engine == "cosmosdb" ? module.azure[0].app_url : ""
}

output "app_url_swagger" {
  value = var.cloud_provider == "azure" && var.db_engine == "cosmosdb" ? "${module.azure[0].app_url}/swagger-ui/index.html" : ""
}
